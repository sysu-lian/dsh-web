...
/* ── message timeline (reasoning / tools) ────────────────────────────── */
...
.chat-timeline-content .chat-code {
  margin-top: 4px;
}

.chat-timeline-reasoning .chat-timeline-content {
  color: var(--dsw-alias-label-tertiary);
  font-size: 13px;
  line-height: 22px;
}

/* Legacy disclosure styles kept for backwards compatibility; the surface now
   renders reasoning/tools as expanded timeline rows above. */
